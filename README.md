# Score - Nodejs-test-template

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/azurelaboratory/nodejs-test-template)
...
humctl config set app nodejs-test-template
